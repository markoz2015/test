...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		<title>Mark's Web Profolio - 404</title>
		...
		<link rel="shortcut icon" href="http://www.markoz.net/img/favicon.ico"/>
		<link href='http://fonts.googleapis.com/css?family=Architects+Daughter|Open+Sans' rel='stylesheet' type='text/css'/>
		<link href="http://www.markoz.net/c/master.css" rel="stylesheet" type="text/css" />
	</head>
	<body>
		<div class="m-cont">
			<div class="full-page">
				<div id="titles-alt">
					...
					<p class="hand-font">this page either couldn't be found or doesn't exist anymore</p>
				</div>
